...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default=r'MOT16_eval/People .mp4', help='source')
    parser.add_argument('--output', type=str, default='inference/output', help='output folder')  # output folder
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[500], help='inference size h,w')
